...
RSpec.describe RevisionsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all revisions as @revisions" do
      ...
      expect(assigns(:revisions)).to eq([revision])
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested revision" do
        revision = Revision.create! valid_attributes
        put :update, {:id => revision.to_param, :revision => new_attributes}, valid_session
        revision.reload
      ...
      it "redirects to the revision" do
        revision = Revision.create! valid_attributes
        put :update, {:id => revision.to_param, :revision => valid_attributes}, valid_session
        expect(response).to redirect_to(revision)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the revision as @revision" do
        revision = Revision.create! valid_attributes
        put :update, {:id => revision.to_param, :revision => invalid_attributes}, valid_session
        expect(assigns(:revision)).to eq(revision)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the revisions list" do
      revision = Revision.create! valid_attributes
      delete :destroy, {:id => revision.to_param}, valid_session
      expect(response).to redirect_to(revisions_url)
    end
  end
